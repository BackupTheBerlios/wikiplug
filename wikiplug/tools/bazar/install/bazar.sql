...
--
-- Serveur: localhost
-- Généré le : Mer 20 Février 2008 à 10:42
...
DROP TABLE IF EXISTS `bazar_appropriation`;
CREATE TABLE IF NOT EXISTS `bazar_appropriation` (
...
--
-- Contenu de la table `bazar_appropriation`
--
...
DROP TABLE IF EXISTS `bazar_fichier_joint`;
CREATE TABLE IF NOT EXISTS `bazar_fichier_joint` (
...
CREATE TABLE IF NOT EXISTS `bazar_nature` (
  ...
  `bn_type_fiche` varchar(90) NOT NULL default '0',
...
DROP TABLE IF EXISTS `bazar_url`;
CREATE TABLE IF NOT EXISTS `bazar_url` (
