CREATE TABLE IF NOT EXISTS `BAZ_PREFIXEfiche` (
...
INSERT INTO `BAZ_PREFIXEfiche` (`bf_id_fiche`, `bf_ce_utilisateur`, `bf_ce_nature`, `bf_titre`, `bf_description`, `bf_date_debut_validite_fiche`, `bf_date_fin_validite_fiche`, `bf_date_creation_fiche`, `bf_date_maj_fiche`, `bf_statut_fiche`, `bf_ce_langue`, `bf_nb_consultations`, `bf_latitude`, `bf_longitude`, `bf_categorie_fiche`) VALUES
(8, 'FloriaN', 16, 'Université de Bourgogne', NULL, '2009-11-29', '0000-00-00', '2009-11-29 16:31:09', '2010-02-16 13:10:16', 1, '', 85, '', '', 'toutes'),
(5, 'FloriaN', 6, 'sdqsqdssqd', NULL, '2009-11-29', '0000-00-00', '2009-11-29 14:59:52', '2009-11-29 16:27:27', 1, '', 1, '', '', 'toutes'),
(3, 'FloriaN', 6, 'Quoi???', 'J''ai toujours trop de travail..', '2009-11-23', '0000-00-00', '2009-11-29 11:22:32', '2009-12-05 21:30:35', 1, '', 14, '', '', 'toutes'),
...
(24, 'FloriaN', 1, 'test', NULL, '2010-04-07', '0000-00-00', '2010-04-07 16:27:41', '2010-04-07 16:27:41', 1, '', 5, '', '', 'toutes'),
(20, 'FloriaN', 20, 'Yes we can', NULL, '2010-02-05', '0000-00-00', '2010-02-05 10:38:53', '2010-02-05 10:39:26', 1, '', 45, '', '', 'universites'),
(21, 'FloriaN', 16, 'zz', NULL, '2010-03-04', '0000-00-00', '2010-03-04 09:26:32', '2010-03-04 09:49:02', 1, '', 1, '', '', 'universites'),
(23, 'FloriaN', 20, 'action directe', NULL, '2010-03-26', '0000-00-00', '2010-03-26 12:15:14', '2010-03-26 12:15:14', 1, '', 37, '', '', 'toutes'),
(22, 'FloriaN', 19, 'balade de Florian', NULL, '2010-03-08', '0000-00-00', '2010-03-08 17:39:07', '2010-03-23 19:54:31', 1, '', 21, '', '', 'toutes'),
(19, 'FloriaN', 16, 'Univertisé claret', NULL, '2010-01-25', '0000-00-00', '2010-01-25 18:27:44', '2010-02-16 12:01:14', 1, '', 39, '', '', 'toutes'),
(16, 'FloriaN', 16, 'Université Montpellier 2', NULL, '2009-12-09', '0000-00-00', '2009-12-09 20:12:29', '2010-03-26 12:15:44', 1, '', 70, '43.6314038', '3.8610052', 'toutes'),
(17, 'FloriaN', 19, 'test ballades', NULL, '2010-01-08', '0000-00-00', '2010-01-08 14:36:02', '2010-01-08 23:27:55', 1, '', 32, '', '', 'toutes'),
(18, 'FloriaN', 19, 'test ballades 2', NULL, '2010-01-08', '0000-00-00', '2010-01-08 23:53:48', '2010-01-08 23:53:48', 1, '', 22, '', '', 'toutes');

CREATE TABLE IF NOT EXISTS `BAZ_PREFIXEfiche_valeur_liste` (
...
INSERT INTO `BAZ_PREFIXEfiche_valeur_liste` (`bfvl_ce_fiche`, `bfvl_ce_liste`, `bfvl_valeur`) VALUES
(3, '30', 1),
(3, '30', 2),
(3, '30', 3),
(3, '30', 17),
...
(15, 'liste31', 2),
(15, 'listefiche6', 7),
(16, 'checkboxfiche20', 20),
(16, 'checkboxfiche20', 23),
...
(16, 'liste1astronomie', 1),
(16, 'liste1biologie', 2),
(16, 'liste1botanique', 2),
(16, 'liste1chimie', 3),
(16, 'liste31', 1),
(17, 'checkbox30', 8),
(17, 'checkbox30', 9),
...
(20, 'checkbox36', 3),
(20, 'listefiche16', 8),
(21, 'liste12autonomie', 1),
(21, 'liste12culture', 2),
(21, 'liste12CultureST', 2),
(21, 'liste12Patrimoine', 2),
(21, 'liste12pres', 2),
(21, 'liste19', 31),
(21, 'liste31', 1),
(22, 'checkbox30', 1),
...
CREATE TABLE IF NOT EXISTS `BAZ_PREFIXEfiche_valeur_texte` (
...
INSERT INTO `BAZ_PREFIXEfiche_valeur_texte` (`bfvt_ce_fiche`, `bfvt_id_element_form`, `bfvt_texte`) VALUES
...
(8, 'bf_adresse1', 'Maison de lâ€™Université '),
(8, 'bf_adresse2', 'Esplanade Erasme'),
(8, 'bf_code_postal', '21000'),
(8, 'bf_ville', 'Dijon'),
(8, 'bf_ce_pays', 'fr'),
(8, 'bf_site_internet', 'http://'),
...
(21, 'bf_titre', 'zz'),
(21, 'bf_adresse1', 'zz'),
(21, 'bf_code_postal', 'zz'),
(21, 'bf_ville', 'zz'),
(21, 'bf_effectif_etudiant', '11'),
(21, 'bf_effectif_personnel', '1213'),
(21, 'bf_effectif_enseignant', '213213'),
(22, 'bf_titre', 'balade de Florian'),
(22, 'bf_site_internet', 'http://florian-express.info'),
(22, 'bf_ce_pays', 'fr'),
(22, 'carte_google', '43.7910904|3.7298624'),
(22, 'bf_adresse1', 'rue de massargue'),
(22, 'bf_code_postal', '34380'),
(22, 'bf_ville', 'saint martin de londres'),
(9, 'bf_titre', 'ddd'),
...
(16, 'bf_ce_pays', 'fr'),
(24, 'fichier1', '<a href=\\"tools/bazar/actions/bazar/upload/1bazar.sql\\">Télécharger le fichier fichier1</a>'),
...
(8, 'carte_google', '47.3147547|5.06678'),
...
(19, 'bf_titre', 'Univertisé claret'),
(19, 'bf_adresse1', 'claret'),
(16, 'carte_google', '43.6314038|3.8610052'),
(16, 'bf_autres_collections_autres', 'YOUPI'),
(23, 'bf_titre', 'action directe'),
(23, 'bf_type_action_autre', 'dd'),
(23, 'bf_participation_evenement', 'dd'),
...
(16, 'bf_adresse2_structure', 'efrefgtÂ²'),
(16, 'bf_code_postal_structure', 'frefeÂ²'),
...
(21, 'carte_google', '43.6|3.883'),
(21, 'bf_ce_pays', 'fr'),
(18, 'bf_site_internet', 'http://'),
(18, 'bf_ce_pays', 'fr'),
(16, 'bf_adresse2', 'Bataillon'),
(16, 'nb_col_astronomie', '12'),
(16, 'bf_latitude', '43.6314038'),
(16, 'bf_longitude', '3.8610052');

CREATE TABLE IF NOT EXISTS `BAZ_PREFIXEfiche_valeur_texte_long` (
...
INSERT INTO `BAZ_PREFIXEfiche_valeur_texte_long` (`bfvtl_ce_fiche`, `bfvtl_id_element_form`, `bfvtl_texte_long`) VALUES
...
(16, 'nb_infos_complementaires_astronomie', 'tres bien'),
...
(8, 'bf_structure_publications_cst', ''),
(8, 'bf_structure_publications_patrimoine', ''),
(8, 'bf_nom_monument_historique', ''),
(8, 'nb_infos_complementaires_archeologie', ''),
(8, 'nb_infos_complementaires_astronomie', ''),
(8, 'nb_infos_complementaires_biologie', ''),
(8, 'nb_infos_complementaires_bota', ''),
(8, 'nb_infos_complementaires_chimie', ''),
(8, 'nb_infos_complementaires_geologie', ''),
(8, 'nb_infos_complementaires_medecine', ''),
(8, 'nb_infos_complementaires_mineralogie', ''),
(8, 'nb_infos_complementaires_odontologie', ''),
(8, 'nb_infos_complementaires_paleontologie', ''),
(8, 'nb_infos_complementaires_pharmacie', ''),
(8, 'nb_infos_complementaires_physique', ''),
(8, 'nb_infos_complementaires_zoologie', ''),
(8, 'nb_infos_complementaires_arts', ''),
(8, 'nb_infos_complementaires_geographie', ''),
(22, 'bf_descriptif', 'youpi'),
(22, 'bf_video', ''),
(22, 'bf_horaires', ''),
(22, 'bf_tarifs', ''),
(23, 'bf_informations_complementaires', ''),
(24, 'bf_commentaire', 'fdfd');
...
(21, 'Personnes', 'Université Personnel', '', 0, 0, 0, '', '', '', '', 'texte***bf_titre***Nom et prénom***60***255*** *** *** ***1***0***\r\nlistefiche***16***Université de rattachement*** *** *** *** *** ***1***1***\r\ncheckbox***37***Domaine(s) d''activité(s)*** *** *** *** *** ***1***1*** ***\r\nlabelhtml***<h3>Informations générales</h3>*** ***<h3>Informations générales</h3>*** *** *** *** ***1***1***\r\ntexte***bf_fonctions***Fonction(s)***60***255*** *** *** ***1***0***\r\nliste***34***Statut*** *** *** *** *** ***0***0***\r\nliste***35***Type emploi*** *** *** *** *** ***0***0***(plein temps ; temps partiel)\r\ntexte***nom_service***Nom du service***60***255*** *** *** \r\ntexte***bf_entite_rattachement_directe***Entité de rattachement directe***60***255*** *** *** ***0***0***A quelle entité la personne est-elle directement attachée? Par exemple : Si la personne est rattaché au service communication de l''université, vous répondez "Service communication"\r\ntexte***bf_entite_rattachement_globale***Entité de rattachement globale***60***255*** *** *** ***0***0***Quelle est la hiérarchie supérieure de la personne? Par exemple : Si la personne est rattachée au service communication de l''université qui est lui-même rattaché à la direction de la Culture, vous répondez "Direction de la Culture"\r\nlabelhtml***<h3>Coordonnées</h3>*** ***<h3>Coordonnées</h3>*** *** *** *** ***1***1***\r\ntexte***bf_telephone***Téléphone***15***15*** *** *** ***0***0\r\nchamps_mail***bf_mail***Courriel***40***255*** *** *** ***1***1\r\ntexte***bf_adresse1***Adresse postale***50***50*** *** *** ***1***0\r\ntexte***bf_adresse2***Adresse (suite)***50***50*** *** *** ***0***0\r\ntexte***bf_code_postal***Code postal***8***8*** *** *** ***1***0\r\ntexte***bf_ville***Ville***50***80*** *** *** ***1***0\r\nliste***19***Département*** ***1*** *** *** ***1***1*** *** *** ***0***0***\r\nchamps_cache***bf_ce_pays***Pays***400*** ***fr*** ***gip_id_pays*** ***\r\ncarte_google*** *** ***bf_latitude***bf_longitude*** *** *** ***\r\nlabelhtml***<h3>Informations complémentaires</h3>*** ***<h3>Informations complémentaires</h3>*** *** *** *** ***1***1***\r\ntextelong***bf_informations_complementaires***Informations complémentaires***40***20*** *** *** *** \r\n', 'fr-FR', 'universites', 'universite');
