...
function fiches_a_valider() {
	...
	if ($resultat->numRows() != 0) {
		...
		while ($ligne = $resultat->fetchRow (DB_FETCHMODE_ASSOC)) {
			...
			// Nettoyage de l'url
			// NOTE (jpm - 23 mai 2007): pour ÃƒÂ¯Ã‚Â¿Ã‚Â½tre compatible avec PHP5 il faut utiliser tjrs $GLOBALS['_BAZAR_']['url'] car en php4 on
			// copie bien une variable mais pas en php5, cela reste une rÃƒÂ¯Ã‚Â¿Ã‚Â½fÃƒÂ¯Ã‚Â¿Ã‚Â½rence...
	...
	if ($resultat->numRows() != 0) {
		...
		while ($ligne = $resultat->fetchRow (DB_FETCHMODE_ASSOC)) {
			...
			// Nettoyage de l'url
			// NOTE (jpm - 23 mai 2007): pour ÃƒÂªtre compatible avec PHP5 il faut utiliser tjrs $GLOBALS['_BAZAR_']['url'] car en php4 on
			// copie bien une variable mais pas en php5, cela reste une rÃƒÂ©fÃƒÂ©rence...
			$GLOBALS['_BAZAR_']['url']->removeQueryString(BAZ_VARIABLE_ACTION);
			$GLOBALS['_BAZAR_']['url']->removeQueryString('id_fiche');
			$GLOBALS['_BAZAR_']['url']->removeQueryString('typeannonce');
...
/** baz_affiche_flux_RSS() - affiche le flux rss ÃƒÂƒÃ‚Â  partir de parametres
*
*
