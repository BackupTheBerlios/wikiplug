...
$res='';
$res .= '<div style="width:200px;float:right;background:white;padding:10px;"><h2 style="font:14px verdana;text-align:center;">Se pr&eacute;-inscrire par mail</h2>'."\n";
if ($total > 0)
{
...
$form_contact = new HTML_QuickForm('inscription', 'post', $this->config['base_url'].$page.'/preinscription');
...
$form_contact->addElement('hidden', 'page', $this->tag);
...
$option = array('style'=>'width:100px;border:1px solid black;font:10px verdana;margin:2px;');
