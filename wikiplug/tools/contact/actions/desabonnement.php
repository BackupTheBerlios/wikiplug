...
// +------------------------------------------------------------------------------------------------------+
// CVS : $Id: desabonnement.php,v 1.1 2009/09/21 14:54:47 mrflos Exp $
/**
* desabonnement.php
*
* Description :
...
if (empty($mail)) {die('Action desabonnement : parametre mail obligatoire');}
echo '<div class="formulairemail">
<div class="note"></div>
<form id="ajax-desabonne-form" action="javascript:alert(\'success!\');">
	<label>Votre adresse mail</label>
	<input class="textbox" type="text" name="email" value="" />
	<input class="button" type="submit" name="submitnewsletter" value="Se d&eacute;sabonner" />
