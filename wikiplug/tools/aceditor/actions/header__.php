...
if ($this->GetMethod() == "edit") {
	...
	#toolbar, #toolbar_suite, #toolbar_chameau { margin:0; width: 100%; padding:0; height:20px; background: #ccc; border-top: 1px solid buttonhighlight; border-left: 1px solid buttonhighlight; border-bottom: 1px solid buttonshadow; border-right: 1px solid buttonshadow; text-align:left; }
	#toolbar a, #toolbar_suite a, #toolbar_chameau a {color:#000;}
