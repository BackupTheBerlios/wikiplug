...
echo htmlentities('<iframe class="yeswiki_frame" width="960" height="700" frameborder="0" src="'.$this->Href('iframe').'"></iframe>')."\n";
echo '</div>'."\n";
echo "Copier-collez ce code dans n'importe quelle page HTML pour intégrer le contenu de la page Wikini ci dessous.<br />"."\n";
echo '<iframe class="yeswiki_frame" width="960" height="700" frameborder="0" src="'.$this->Href('iframe').'"></iframe>';
echo $this->Footer();
