<?php
/*
$Id: include.php,v 1.1 2008/06/18 10:45:25 mrflos Exp $
...
elseif ($this->HasAccess('read', $incPageName))
{
	...
	if (!empty($dblclic)&&$dblclic=="1") {
		$output = '<div style="display:block;width:100%;height:100%;" ondblclick="document.location=\''.$this->Href("edit", $incPageName).'\';">'."\n".$output."\n".'<div style="clear:both;display:block;"></div>'."\n".'</div>'."\n";
	}
