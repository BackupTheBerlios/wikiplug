<?
//on inclue Simplepie le parser RSS
include('tools/tags/lib/simplepie.inc');

//pour cacher les erreurs Warning de Simplepie
...
if (empty($template)) {
	...
	if (!file_exists($template)) {
			...
			$template = 'tools/tags/presentation/liste_rss.tpl.html';
	}
}
...
if (!empty($urls)) {
	...
	if ($tri) krsort($syndication['pages']);
//var_dump($syndication['pages']);break;
